                ...
                <div className=" fixed bottom-5 w-full">
                    <div className="flex justify-center">
                        <form onSubmit={handelSubmit} method='post' className='relative'>
                            <textarea name='userquerry' className="min-w-[450px] w-[45vw]  bg-[#1e2f36] text-white flex p-3 outline-none border-none justify-center max-h-[350px] pr-[10%] break-all"  style={{ height: inputHeight ,resize: "none"}} placeholder="Type your message..." value={message} onChange={handleInputChange} resize="none"/>
                            
                            <button className='absolute bottom-[1%] bg-[#477590] p-1 rounded-lg m-2 right-0 text-white ' type='submit'><IoSend size={30}/></button>
                        </form>        
                    </div>
                </div>
            </div>
