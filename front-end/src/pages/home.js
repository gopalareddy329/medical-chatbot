...
const Home = () => {
  return (
    ...
    <div className='flex flex-col gap-10 my-font'> 
      ...
      <div className='h-fit text-white bg-[#003554] min-h-[800px] p-[70px] mt-20 Staatliches'>
        ...
        <div className=' flex flex-col  gap-[50px]  '>
            ...
            <div className='flex  gap-10 w-full my-font text-[16px] max-w-[1200px]   justify-between max-md:flex-col max-md:gap-0'>
                ...
                <div className='max-w-[500px] max-md:mt-10 p-8'>
                        <p>
          ...
          <div className='mt-[10%] gap-2 text-[#00A6FB] w-full p-5 flex items-center justify-center max-md:flex-col '>
